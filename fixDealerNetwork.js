...
const dirs = [
    'src/app/(app)/dealer-network/**/*.tsx'
];
...
console.log('Found ' + filesToProcess.length + ' files to process in dealer-network.');
...
filesToProcess.forEach(file => {
    ...
    // 2. Container background alternative form (e.g. B2B Katalog Yönetimi)
    content = content.replace(/className=\"([^\"]*)bg-slate-50\s+min-h-screen([^\"]*)\"/g,
        'className=\"$1bg-slate-50 min-h-screen dark:bg-[#020617] dark:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] dark:from-slate-900/40 dark:via-[#020617] dark:to-[#020617]$2\"'
    );
    // Replace hardcoded height 100vh with no background if any
    content = content.replace(/<div className=\"min-h-screen p-8\">/g, '<div className="min-h-screen p-8 bg-slate-50 dark:bg-[#020617] dark:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] dark:from-slate-900/40 dark:via-[#020617] dark:to-[#020617]">');
    content = content.replace(/<div className=\"p-8 min-h-screen\">/g, '<div className="p-8 min-h-screen bg-slate-50 dark:bg-[#020617] dark:bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] dark:from-slate-900/40 dark:via-[#020617] dark:to-[#020617]">');
