...
async function run() {
    ...
    const packageId = "3624890380";
    const url = `https://apigw.trendyol.com/integration/order/sellers/${supplierId}/shipment-packages/${packageId}`;
    ...
    if (res.ok) {
        ...
        console.log("FULL PACKAGE RECORD:", JSON.stringify(data, null, 2));
    } else {
