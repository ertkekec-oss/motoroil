    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex justify-between items-center bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800">Website Y├Ânetimi (CMS)</h1>
                    <p className="text-sm text-slate-500">Landing page ve kurumsal sayfalar─▒ dinamik olarak y├Ânetin.</p>
                </div>
