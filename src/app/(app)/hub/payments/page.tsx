    ...
    return (
        <div className="bg-slate-50 min-h-screen dark:bg-[#0f172a] pb-16 w-full font-sans">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-300">
                <div className="mb-8">
                    <h1 className="text-2xl font-semibold text-slate-900 dark:text-white tracking-tight mb-2">📊 Ödemeler & Tahsilat (B2B Banka Entegrasyonu)</h1>
                    <p className="text-sm text-slate-600 dark:text-slate-400">Gelen B2B ödemeler, fon transferleri ve açık banka hareketleri.</p>
                </div>
                ...
                {loading ? (
                    <div className="bg-white dark:bg-[#0f172a] p-12 rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm flex flex-col justify-center items-center">
                        ...
                        <span className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-widest">Banka verileri yükleniyor...</span>
                    </div>
                ) : (
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                            <div className="bg-white dark:bg-[#0f172a] border border-emerald-100 dark:border-emerald-900/30 p-6 rounded-2xl shadow-sm">
                            ...
                            <div className="bg-white dark:bg-[#0f172a] border border-red-100 dark:border-red-900/30 p-6 rounded-2xl shadow-sm">
                            ...
                            <div className="bg-white dark:bg-[#0f172a] border border-blue-100 dark:border-blue-900/30 p-6 rounded-2xl shadow-sm">
                            ...
                            <div className="bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-white/5 p-6 rounded-2xl shadow-sm flex items-center justify-between">
                                <div>
                        ...
                        <div className="bg-white dark:bg-[#0f172a] rounded-2xl border border-slate-200 dark:border-white/5 shadow-sm overflow-hidden">
                            <div className="px-6 py-5 border-b border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-[#1e293b]/50">
                                <h3 className="text-base font-semibold text-slate-900 dark:text-white">Son Banka Hareketleri</h3>
                            </div>
                            ...
                            <div className="p-0">
                                {bankStatements.length === 0 ? (
                                    <div className="p-16 text-center">
                                        ...
                                        <h3 className="font-semibold text-slate-900 dark:text-white mt-4">Henüz Banka Hareketi Yok</h3>
