         ...
         return (
             <div className="min-h-screen bg-slate-50  flex items-center justify-center p-6">
                 <div className="bg-white  p-8 rounded-2xl shadow-sm text-center max-w-md border border-slate-200 ">
                     ...
                     <h2 className="text-xl font-bold text-slate-800  mb-2">İhale Bulunamadı</h2>
                     <p className="text-slate-500  mb-6 text-sm">Aradığınız ihale kaydı bulunamadı veya yetkiniz yok.</p>
                     <Link href="/seller/rfqs" className="inline-flex items-center justify-center bg-slate-900  text-white  px-6 py-2.5 rounded-xl font-bold text-sm hover:bg-slate-800 :bg-slate-100 transition-colors">
                         Müzakerelere Dön
                     </Link>
                 </div>
             </div>
        ...
        <div className="bg-slate-50 min-h-screen  pb-16 w-full font-sans">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-300">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-500  border-b border-slate-200  pb-4 mb-6">
                    <Link href="/seller/rfqs" className="hover:text-slate-900 :text-white transition-colors">Gelen İhaleler</Link>
                    <span>/</span>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-3 text-sm text-slate-600 ">
                                ...
                                <span className="font-semibold text-slate-800 ">{buyerCompany?.name || "Bilinmeyen Alıcı"}</span> firmasından geldi.
                            </div>
                        </div>
                        <Link href="/seller/rfqs" className="inline-flex items-center justify-center gap-2 bg-white  text-slate-700  border border-slate-200  px-4 py-2 rounded-xl font-bold text-sm hover:bg-slate-50 :bg-slate-800 transition-colors shadow-sm shrink-0">
