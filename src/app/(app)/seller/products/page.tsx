            ...
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-300">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-5 mb-6">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        <button
                            className="h-8 px-4 inline-flex items-center justify-center rounded-lg text-[12px] font-bold bg-slate-900  text-white  hover:bg-slate-800 :bg-slate-200 transition-colors shadow-sm gap-2"
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
                    <div className="bg-white  px-5 py-4 rounded-xl border border-slate-200  shadow-sm flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="text-lg font-black text-slate-900  leading-none">{products.length} <span className="text-xs font-semibold text-slate-500 ml-1">Kayıt</span></div>
                        </div>
                    </div>
                    ...
                    <div className="bg-emerald-50/50  px-5 py-4 rounded-xl border border-emerald-100  shadow-sm flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            <div className="text-[10px] font-bold text-emerald-600/70  uppercase tracking-widest mb-0.5">Ağda Satışta (Aktif)</div>
                            <div className="text-lg font-black text-emerald-700  leading-none">{listedCount} <span className="text-xs font-semibold text-emerald-600/70 ml-1">Ürün</span></div>
                        </div>
                    </div>

                    <div className="bg-amber-50/50  px-5 py-4 rounded-xl border border-amber-100  shadow-sm flex items-center gap-4">
                        <div className="w-10 h-10 bg-amber-100  rounded-lg flex items-center justify-center text-amber-600  shrink-0">
                            <PauseCircle className="w-5 h-5" />
                        </div>
                        <div className="flex-1">
                            <div className="text-[10px] font-bold text-amber-600/70  uppercase tracking-widest mb-0.5">Durdurulan İlanlar</div>
                            <div className="text-lg font-black text-amber-700  leading-none">{pausedCount} <span className="text-xs font-semibold text-amber-600/70 ml-1">Ürün</span></div>
                        </div>
                    </div>

                    <div className="bg-slate-50/50  px-5 py-4 rounded-xl border border-slate-200  shadow-sm flex items-center gap-4">
                        <div className="w-10 h-10 bg-slate-200  rounded-lg flex items-center justify-center text-slate-500  shrink-0">
                            <ShieldAlert className="w-5 h-5" />
                        </div>
                        <div className="flex-1">
                            <div className="text-[10px] font-bold text-slate-500  uppercase tracking-widest mb-0.5">B2B Ağına Kapalı</div>
                            <div className="text-lg font-black text-slate-700  leading-none">{unlistedCount} <span className="text-xs font-semibold text-slate-500 ml-1">Ürün</span></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="px-6 py-5 border-b border-slate-100  bg-slate-50  flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="relative w-full md:w-64">
                            <input
                                ...
                                className="w-full text-sm border border-slate-300  rounded-lg px-4 py-2 bg-white  focus:outline-none focus:ring-2 focus:ring-slate-900 :ring-white/20 focus:border-slate-900 :border-white/40 transition-all font-medium placeholder:text-slate-400  text-slate-900  shadow-sm"
                            />
                        </div>
                    </div>
                            ...
                            <tbody className="divide-y divide-slate-100  text-[14px]">
                                {products.length === 0 ? (
                                    ...
                                    products.map(p => {
                                        ...
                                        return (
                                            <tr key={p.id} className="hover:bg-slate-50 :bg-white/5 transition-colors group">
                                                ...
                                                <td className="px-6 py-4 text-right align-middle">
                                                    <Link
                                                        ...
                                                        className={`inline-flex items-center justify-center h-8 px-4 border text-[13px] font-semibold rounded-lg transition-colors shadow-sm focus:outline-none ${isListed
                                                            ? 'bg-white  border-slate-300  text-slate-700  hover:bg-slate-50 :bg-white/10 hover:text-slate-900 :text-white'
                                                            : 'bg-slate-900  border-transparent text-white hover:bg-slate-800 :bg-blue-500'
                                                            }`}
                                                    >
