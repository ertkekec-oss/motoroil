                ...
                <div className="bg-white dark:bg-[#1e293b] border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden mb-8">
                    <div className="p-4 border-b border-slate-200 dark:border-slate-800 flex gap-4 bg-slate-50 dark:bg-[#0f172a]">
                        <form method="GET" className="flex gap-4 items-center">
                            ...
                            <select name="status" defaultValue={status || ''} onChange={(e) => e.target.form?.submit()} className="h-9 px-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#1e293b] text-sm">
                            ...
                            <select name="priority" defaultValue={priority || ''} onChange={(e) => e.target.form?.submit()} className="h-9 px-3 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#1e293b] text-sm">
