    ...
    return (
        <div className="max-w-7xl mx-auto p-6 space-y-5">
            <div className="flex items-center justify-between gap-3">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight text-gray-900">Alınan Siparişler</h1>
                            ...
                            {data.length === 0 ? (
                                ...
                                data.map((o) => (
                                    <tr key={o.id} className="hover:bg-gray-50/50">
                                        ...
                                        <td className="px-4 py-3">
                                            <div className="font-medium text-gray-900">{(companyMap.get(o.buyerCompanyId) as string) ?? "-"}</div>
                                            <div className="text-xs text-gray-500">{o.buyerCompanyId}</div>
                                        </td>
