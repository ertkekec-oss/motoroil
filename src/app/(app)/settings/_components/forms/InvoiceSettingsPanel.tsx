    ...
    return (
        <div className="max-w-4xl animate-in fade-in duration-300">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    <h2 className="text-[24px] font-semibold text-slate-900 tracking-tight">Fatura Formatı & Serileme Modülü</h2>
                    <p className="text-[14px] text-slate-500 mt-1">E-arşiv matbaası, teklif ve irsaliyelerde kullanılacak yasal dizinim metrikleri.</p>
                </div>
                ...
                <ERPBlock title="Yürütme Çarpanı (Sıra)" description="Matbaaya gönderilecek ilk belgenin referans sırası.">
                    <ERPField label="SIRADAKİ FATURA İNDEKSİ" hint="Üretilmiş son belgeden +1 fazlasıdır.">
                        <ERPInput
                            ...
                            readOnly
                            className="bg-slate-50 text-slate-600 font-mono text-lg"
                        />
                    </ERPField>

                    <div className="mt-4 flex items-center justify-between p-3 border border-slate-200 rounded-lg text-[13px] font-medium text-slate-600 bg-slate-50">
                        <span>Gösterim:</span>
                        <span className="font-mono text-slate-900 font-bold bg-white px-2 py-1 border border-slate-200 rounded">
