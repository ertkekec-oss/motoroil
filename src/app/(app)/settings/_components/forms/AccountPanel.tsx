...
function ERPInput(props: any) {
    return (
        <input
            {...props}
            className="w-full h-10 px-3 bg-white border border-slate-300 rounded-lg text-[14px] text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-900 focus:border-slate-900 transition-all shadow-sm disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200"
        />
    );
}
...
export default function AccountPanel(props: any) {
    ...
    return (
        <div className="max-w-4xl animate-in fade-in duration-300">
            {/* Header */}
            <div className="mb-8">
                <h2 className="text-[24px] font-semibold text-slate-900 tracking-tight">Kullanıcı Hesabı</h2>
                <p className="text-[14px] text-slate-500 mt-1">Sistem yetki seviyeniz, profil kimliğiniz ve güvenlik yönetiminiz.</p>
            </div>
            ...
            >
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex flex-col items-center justify-center gap-3 shrink-0">
                        <div className="w-20 h-20 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-2xl font-bold text-slate-900 shadow-sm">
                            {initials}
                        </div>
                        <span className="inline-flex px-2.5 py-1 rounded-md bg-slate-100 text-[11px] font-semibold text-slate-600 uppercase tracking-widest border border-slate-200">
            ...
            >
                ...
                <div className="mt-6 pt-5 border-t border-slate-100 flex justify-end">
                    <button
                        ...
                        className="h-10 px-5 bg-slate-900 border border-slate-900 rounded-lg text-white text-[14px] font-medium hover:bg-slate-800 transition-colors shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-slate-900"
                    >
                        🔒 Şifreyi Güncelle
                    </button>
                </div>
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex items-start gap-4">
                <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 shadow-sm flex items-center justify-center shrink-0 mt-0.5">
                    🛡️
                </div>
                <div>
                    <h4 className="text-[14px] font-semibold text-slate-900">Sistem İzolasyonu ve Yetkiler</h4>
                    <p className="text-[13px] text-slate-600 mt-1 leading-relaxed">
                        Kullanıcı hesabınız çalıştığınız modüllerde tamamen izoledir. Veriye erişim sınıfınız, <strong className="font-semibold text-slate-900">Kurumsal Sistem Yöneticisi</strong> kuralları çerçevesinde belirlenmiştir. Rol tanımlarını değiştirmek için Ana Yetki sayfasına başvurunuz.
                    </p>
                </div>
            </div>
        </div>
