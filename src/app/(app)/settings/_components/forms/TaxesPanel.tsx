    ...
    return (
        <div className="max-w-4xl animate-in fade-in duration-300">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div>
                    <h2 className="text-[24px] font-semibold text-slate-900 tracking-tight">KDV & Vergi Matrah Yapılandırması</h2>
                    <p className="text-[14px] text-slate-500 mt-1">Stok/Hizmet tanımlarında kullanılmak üzere yasal vergi dilimlerini belirleyin.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div className="md:col-span-5">
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-[0px_1px_2px_rgba(0,0,0,0.02)] sticky top-6">
                        <div className="mb-6 pb-5 border-b border-slate-100">
                            <h3 className="text-[16px] font-semibold text-slate-900">Yeni Oran Deklarasyonu</h3>
                            <p className="text-[14px] text-slate-500 mt-1">Mali takvime eklenen yeni yasal istisnai oranlar.</p>
                        </div>
                        ...
                        <div className="space-y-4">
                            <ERPField label="EKLENECEK KDV ORANI (%)">
                                <div className="flex gap-2 relative">
                                    ...
                                    />
                                    <span className="absolute left-[calc(100%-4rem)] top-1/2 -translate-y-1/2 text-slate-400 font-bold ml-1">%</span>

                                    <button
                                        onClick={addKdv}
                                        className="h-10 px-5 bg-slate-900 text-white rounded-lg text-[13px] font-medium shadow-sm hover:bg-slate-800 transition-colors shrink-0 flex items-center gap-2"
                                    >
                                        Ekle <span>+</span>
                                    </button>
                                </div>
                ...
                <div className="md:col-span-7">
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-[0px_1px_2px_rgba(0,0,0,0.02)] overflow-hidden">
                        <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                            <div>
                                <h3 className="text-[16px] font-semibold text-slate-900">Geçerli Yasal Dilimler</h3>
                                <p className="text-[13px] text-slate-500 mt-1">Aşağıdaki oranlar fatura kalemlerinde seçilebilir durumdadır.</p>
                            </div>
                            <span className="inline-flex items-center justify-center min-w-8 h-8 px-2 bg-slate-100 text-[12px] font-bold text-slate-700 rounded-lg border border-slate-200 shadow-sm shrink-0">
                                {kdvRates.length}
                            </span>
                        </div>
                        ...
                        {kdvRates.length > 0 ? (
                                        ...
                                        <tr key={idx} className="hover:bg-slate-50/50 transition-colors group">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div className="text-[14px] font-semibold text-slate-900">Katma Değer Vergisi</div>
                                                        <div className="text-[12px] text-slate-500 uppercase tracking-widest mt-0.5">SİSTEM ONAYLI</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4 text-right align-middle">
                                                <button
                                                    ...
                                                    className="opacity-0 group-hover:opacity-100 h-8 px-3 text-[12px] font-semibold text-red-600 hover:text-red-700 hover:bg-red-50 rounded bg-white border border-red-200 transition-all focus:opacity-100"
                                                >
                                                    İptal Et
                                                </button>
                                            </td>
                            ...
                            <div className="p-16 text-center">
                                ...
                                <p className="text-[15px] font-semibold text-slate-900">Vergi Dilimi Bulunamadı</p>
