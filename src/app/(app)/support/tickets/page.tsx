            ...
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in duration-300">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-5 mb-8">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        <button className="h-10 px-5 inline-flex items-center justify-center rounded-lg text-[13px] font-semibold bg-slate-900 text-white hover:bg-slate-800 :bg-slate-200 transition-colors shadow-sm gap-2">
                        ...
                        <div className="bg-white  p-4 rounded-xl border border-slate-200  shadow-sm flex flex-col sm:flex-row justify-between items-center gap-4">
                            <div className="flex gap-2 w-full sm:w-auto">
                                <select
                                    ...
                                    className="bg-slate-50  border border-slate-200  text-slate-700  text-sm rounded-lg focus:ring-slate-900 :ring-white/10 focus:border-slate-900 :border-white/40 block px-3 py-2 transition-colors w-full sm:w-auto font-medium shadow-sm outline-none"
                                >
                    ...
                    <div className="hidden lg:flex w-[450px] flex-shrink-0 flex-col">
                        {selectedTicket ? (
                            <div className="bg-white  rounded-2xl border border-slate-200  shadow-sm flex flex-col flex-1 max-h-[calc(100vh-120px)] overflow-hidden sticky top-8">
                                <div className="px-6 py-5 border-b border-slate-100  bg-slate-50  flex flex-col justify-center">
                                ...
                                <div className="p-6 flex-1 overflow-y-auto space-y-5 bg-slate-50  custom-scrollbar">
                                    ...
                                    {selectedTicket.status !== 'RESOLVED' ? (
                                        <div className="flex flex-col gap-3">
                                            <textarea
                                                ...
                                                className="w-full bg-white  border border-slate-300  rounded-lg text-[14px] px-4 py-3 outline-none focus:border-slate-900 :border-white/40 focus:ring-2 focus:ring-slate-900 :ring-white/10/10 transition-all font-medium resize-none shadow-sm"
                                            />
