    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex-shrink-0 border-b border-slate-200 dark:border-white/5 bg-white dark:bg-[#0B1220] z-10 sticky top-0">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 lg:px-10 h-auto sm:h-20 py-4 sm:py-0">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-[16px] bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center p-0.5 shadow-lg shadow-blue-500/20">
                            <div className="w-full h-full rounded-[14px] bg-white/10 flex items-center justify-center border border-white/20 backdrop-blur-md">
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="px-2 py-0.5 rounded-[6px] bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 text-[10px] font-black text-blue-600 dark:text-blue-400 tracking-wider">ENTERPRISE</span>
                            </div>
                            <span className="text-[13px] font-medium text-slate-500 dark:text-slate-400 mt-1.5 flex items-center gap-1.5">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-[300px] h-10 pl-9 pr-4 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 rounded-[12px] text-[13px] font-medium text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder-slate-400"
                            />
                        </div>
            ...
            {/* Dashboard Content */}
            <div className="p-6 lg:p-10 space-y-8 flex-1 w-full max-w-[1600px] mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <Link href="/service/work-orders?status=PENDING" className="group rounded-[24px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 overflow-hidden relative transition-all hover:shadow-xl hover:-translate-y-1">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div className="w-12 h-12 rounded-[16px] bg-amber-50 dark:bg-amber-500/10 flex items-center justify-center text-amber-600 dark:text-amber-500 border border-amber-100 dark:border-amber-500/20">
                            ...
                            <h3 className="text-[14px] font-bold text-slate-900 dark:text-white mb-1">Açık İş Emirleri</h3>
                            <p className="text-[13px] text-slate-500 dark:text-slate-400 font-medium line-clamp-1">Atanmayı Bekleyen Kayıtlar</p>
                        </div>
                        <div className="px-6 py-3 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-white/5 flex justify-between items-center text-[12px] font-bold text-slate-600 dark:text-slate-300">
                    ...
                    <Link href="/service/work-orders?status=IN_PROGRESS" className="group rounded-[24px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 overflow-hidden relative transition-all hover:shadow-xl hover:-translate-y-1">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div className="w-12 h-12 rounded-[16px] bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center text-blue-600 dark:text-blue-500 border border-blue-100 dark:border-blue-500/20">
                            ...
                            <h3 className="text-[14px] font-bold text-slate-900 dark:text-white mb-1">İşlemde Olanlar</h3>
                            <p className="text-[13px] text-slate-500 dark:text-slate-400 font-medium line-clamp-1">Teknisyen / Saha Ekiplerinde</p>
                        </div>
                        <div className="px-6 py-3 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-white/5 flex justify-between items-center text-[12px] font-bold text-slate-600 dark:text-slate-300">
                    ...
                    <Link href="/service/assets" className="group rounded-[24px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 overflow-hidden relative transition-all hover:shadow-xl hover:-translate-y-1">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div className="w-12 h-12 rounded-[16px] bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-500 border border-emerald-100 dark:border-emerald-500/20">
                                    <ShieldCheck className="w-6 h-6" />
                                </div>
                                <Activity className="w-8 h-8 text-slate-200 dark:text-slate-700" />
                            </div>
                            <h3 className="text-[14px] font-bold text-slate-900 dark:text-white mb-1">Cihaz & Garantiler</h3>
                            <p className="text-[13px] text-slate-500 dark:text-slate-400 font-medium line-clamp-1">Müşteri Varlıkları, Seri Numaraları</p>
                        </div>
                        <div className="px-6 py-3 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-white/5 flex justify-between items-center text-[12px] font-bold text-slate-600 dark:text-slate-300">
                    ...
                    <Link href="/field-sales" className="group rounded-[24px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 overflow-hidden relative transition-all hover:shadow-xl hover:-translate-y-1">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-start mb-4">
                                <div className="w-12 h-12 rounded-[16px] bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center text-indigo-600 dark:text-indigo-500 border border-indigo-100 dark:border-indigo-500/20">
                                    <MapPin className="w-6 h-6" />
                                </div>
                                <Activity className="w-8 h-8 text-slate-200 dark:text-slate-700" />
                            </div>
                            <h3 className="text-[14px] font-bold text-slate-900 dark:text-white mb-1">Saha Ekibi</h3>
                            <p className="text-[13px] text-slate-500 dark:text-slate-400 font-medium line-clamp-1">Kurulum, Rota ve Mobil Uygulama</p>
                        </div>
                        <div className="px-6 py-3 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-white/5 flex justify-between items-center text-[12px] font-bold text-slate-600 dark:text-slate-300">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="p-8 rounded-[24px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 shadow-sm relative overflow-hidden">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                                    <HardHat className="w-5 h-5 text-slate-400" /> Son İş Emirleri
                                </h3>
                                <Link href="/service/work-orders" className="text-sm font-semibold text-blue-500 hover:text-blue-600">Tümünü Göster</Link>
                            </div>

                            <div className="overflow-x-auto custom-scroll -mx-8 px-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="p-8 rounded-[24px] bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 shadow-sm relative overflow-hidden flex flex-col justify-between h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-50/50 via-white to-white dark:from-slate-800/50 dark:via-slate-900 dark:to-slate-900">
                            <div>
                                ...
                                <p className="text-[13px] text-slate-500 dark:text-slate-400 font-medium mt-3">Açık İş Emirlerinden doğan tahmini ciro potansiyeli.</p>
                            </div>
                            
                            <div className="mt-8 space-y-4">
                                <div className="flex items-center justify-between p-4 rounded-[16px] bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-white/5">
                                    <div className="flex items-center gap-3">
                                        <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 flex items-center justify-center">👨‍🔧</div>
                                        <div>
                                            <div className="text-[12px] font-bold text-slate-900 dark:text-white">Çalışan Ekipler</div>
                                            <div className="text-[11px] font-medium text-slate-500">Saha ve Ofis Teknik Personeli</div>
                                        </div>
                                    </div>
                                    <span className="text-[14px] font-bold text-slate-900 dark:text-white">Aktif</span>
                                </div>
                            </div>
                        </div>
                    </div>
