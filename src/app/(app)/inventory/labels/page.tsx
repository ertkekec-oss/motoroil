                ...
                <div className="p-6 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <button onClick={() => setTargetType("all")} className={`h-10 px-4 rounded-full border text-xs font-bold tracking-wide transition-all ${targetType === "all" ? 'bg-slate-900 text-white border-transparent' : 'bg-slate-50 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300'}`}>Tüm Envanter</button>
                            <button onClick={() => setTargetType("single")} className={`h-10 px-4 rounded-full border text-xs font-bold tracking-wide transition-all ${targetType === "single" ? 'bg-slate-900 text-white border-transparent' : 'bg-slate-50 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300'}`}>Tek Ürün</button>
                            <button onClick={() => setTargetType("category")} className={`h-10 px-4 rounded-full border text-xs font-bold tracking-wide transition-all ${targetType === "category" ? 'bg-slate-900 text-white border-transparent' : 'bg-slate-50 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300'}`}>Kategori</button>
                            <button onClick={() => setTargetType("brand")} className={`h-10 px-4 rounded-full border text-xs font-bold tracking-wide transition-all ${targetType === "brand" ? 'bg-slate-900 text-white border-transparent' : 'bg-slate-50 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300'}`}>Marka</button>
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            {["30x50", "40x80", "50x100"].map(size => (
                                <button key={size} onClick={() => setLabelSize(size)} className={`w-full flex items-center justify-between p-3 rounded-full border cursor-pointer transition-all ${labelSize === size ? 'border-blue-500 bg-blue-50 dark:bg-blue-500/10' : 'border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/5'}`}>
