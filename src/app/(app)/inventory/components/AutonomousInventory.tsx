...
export function DailyBriefPanel({ onClose }: { onClose: () => void }) {
    return (
        <div className="bg-white border-l-4 border-l-blue-600 border border-slate-200 rounded-2xl shadow-sm p-6 mb-6 animate-in slide-in-from-top-4">
            <div className="flex justify-between items-start mb-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">Sistem tarafından analiz edilen günlük stratejik aksiyon özeti.</p>
                </div>
                <button onClick={onClose} className="text-slate-400 hover:text-slate-600 text-[11px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-200">
                    Bugünlük Gizle
                </button>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 shadow-sm flex flex-col justify-between">
                    ...
                    <div className="text-xl font-black text-slate-900 mt-2">5 Ürün</div>
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 shadow-sm flex flex-col justify-between">
                    ...
                    <div className="text-xl font-black text-slate-900 mt-2">3 Ürün</div>
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 shadow-sm flex flex-col justify-between">
                    ...
                    <div className="text-xl font-black text-slate-900 mt-2">2 Ürün</div>
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 shadow-sm flex flex-col justify-between">
                    ...
                    <div className="text-xl font-black text-slate-900 mt-2">₺48.500</div>
                </div>
                <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 shadow-sm flex flex-col justify-between">
                    ...
                    <div className="text-xl font-black text-slate-900 mt-2">4 Ürün</div>
                </div>
            </div>
...
export function WeeklyHealthReport({ onClose }: { onClose: () => void }) {
    return (
        <div className="fixed inset-y-0 right-0 w-full md:w-[480px] bg-white border-l border-slate-200 shadow-2xl z-[5000] flex flex-col animate-in slide-in-from-right duration-300">
            <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Envanter sağlığı ve trend analizi</p>
                </div>
                <button onClick={onClose} className="p-2 rounded-lg hover:bg-slate-200/50 text-slate-500 transition-colors">✕</button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
                ...
                <div className="flex flex-col items-center justify-center p-6 bg-slate-900 rounded-2xl text-white shadow-sm">
                    ...
                    <div className="text-5xl font-black mt-2 text-emerald-400">78<span className="text-xl text-slate-500">/100</span></div>
                ...
                <div className="space-y-4">
                    <h3 className="text-xs font-bold uppercase tracking-widest text-slate-900">Key Metrics</h3>

                    <div className="grid grid-cols-2 gap-3">
                        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                            <div className="text-[11px] font-bold text-slate-500 uppercase">Ortalama Stok Gün</div>
                            <div className="text-lg font-black text-slate-900 mt-1">42 Gün</div>
                        </div>
                        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                            <div className="text-[11px] font-bold text-slate-500 uppercase">Fazla Stok Oranı</div>
                            <div className="text-lg font-black text-slate-900 mt-1">%14.2</div>
                        </div>
                ...
                <div className="space-y-4">
                    <h3 className="text-xs font-bold uppercase tracking-widest text-slate-900">En Çok Satan 5 Ürün</h3>
                    <div className="bg-white border border-slate-200 rounded-xl divide-y divide-slate-100 overflow-hidden">
                        {[1, 2, 3, 4, 5].map(i => (
                            <div key={i} className="flex items-center justify-between p-3 text-sm">
                                <span className="font-medium text-slate-700">Premium Madeni Yağ 5W-30 {i}</span>
    ...
    return (
        <div className="space-y-4 animate-in fade-in">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm transition-all hover:shadow-md">
                <div className="mb-6 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1 font-medium ml-10">Algoritmik önceliklendirilmiş aksiyon listesi.</p>
                    </div>
                </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-slate-50 border-b border-slate-200">
                            <tr>
                                <th className="px-4 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Risk Tipi</th>
                                <th className="px-4 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Ürün</th>
                                <th className="px-4 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Tahmini Etkisi</th>
                                <th className="px-4 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Önerilen Aksiyon</th>
                                <th className="px-4 py-3 text-right text-xs font-semibold text-slate-500 uppercase tracking-wider">Operasyon</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                            {anomalies.map((a, i) => (
                                <tr key={i} className="hover:bg-slate-50 transition-colors group">
                                    ...
                                    <td className="px-4 py-3 text-[13px] font-bold text-slate-900">{a.product}</td>
                                    <td className="px-4 py-3 text-[13px] font-bold text-slate-600">{a.impact}</td>
                                    <td className="px-4 py-3 text-[13px] font-medium text-slate-500 flex items-center gap-2">
                                    ...
                                    <td className="px-4 py-3 text-right whitespace-nowrap">
                                        ...
                                        <button className="px-3 py-1.5 bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 rounded-lg text-xs font-bold transition-colors shadow-sm ml-2">
                                            Detay
                                        </button>
                                    </td>
                                </tr>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white border-l-4 border-l-amber-500 p-6 rounded-2xl border border-slate-200 shadow-sm">
                    <h4 className="text-sm font-bold text-slate-900 mb-2 flex items-center gap-2"><Activity className="w-4 h-4 text-amber-500" /> Smart Simulation (What-If)</h4>
                    <p className="text-xs text-slate-500 mb-4">Senaryo tabanlı stratejik karar motoru.</p>

                    <div className="space-y-3">
                        <div className="flex justify-between items-center text-sm border-b border-slate-100 pb-2">
                            <span className="text-slate-600 font-medium">Fiyat %10 artarsa (30 Gün Etki)</span>
                            <span className="font-bold text-emerald-600">+₺24.500 Ciro</span>
                        </div>
                        <div className="flex justify-between items-center text-sm border-b border-slate-100 pb-2">
                            <span className="text-slate-600 font-medium">Atıl Stok B2B'de (Suni Gelir)</span>
                            <span className="font-bold text-blue-600">+₺41.000 Tahsilat</span>
                        </div>
                    </div>
                </div>

                <div className="bg-white border-l-4 border-l-emerald-500 p-6 rounded-2xl border border-slate-200 shadow-sm">
                    <h4 className="text-sm font-bold text-slate-900 mb-2 flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500" /> Anomaly Tracker (Audit)</h4>
                    <p className="text-xs text-slate-500 mb-4">Gerçek zamanlı sistem denetimi anomali kayıtları.</p>

                    <div className="space-y-3">
                        <div className="flex items-center justify-between text-xs">
                            <div className="flex items-center gap-2">
                                <div className="w-2 h-2 rounded-full bg-red-500"></div>
                                <span className="text-slate-600 font-medium">Ani Satış Sıçraması (ID: 8042)</span>
                            </div>
                        ...
                        <div className="flex items-center justify-between text-xs">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-slate-600 font-medium">Fiyat Sapması Uyarısı (ID: 1024)</span>
                            </div>
...
export function ExecutiveSummaryMode({ products }: { products: any[] }) {
    return (
        <div className="space-y-6 animate-in fade-in">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Stok Sağlık Skoru</span>
                    </div>
                    <div className="text-3xl font-black text-slate-900 mt-2">78<span className="text-lg text-slate-400 font-bold">/100</span></div>
                    <div className="mt-4">
                ...
                <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Ortalama Devir Süresi</span>
                    </div>
                    <div className="text-3xl font-black text-slate-900 mt-2">42 <span className="text-lg text-slate-400 font-bold">Gün</span></div>
                ...
                <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Atıl Stok Tutarı</span>
                    </div>
                    <div className="text-3xl font-black text-slate-900 mt-2">₺184K</div>
                ...
                <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Kritik SKU Sayısı</span>
                    </div>
            ...
            <div className="bg-white border-slate-200 rounded-2xl shadow-sm p-6 border">
                <h3 className="text-sm font-bold text-slate-900 mb-4">Stratejik Risk Dağılımı</h3>
