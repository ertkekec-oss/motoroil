                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-[11px] font-medium text-slate-500 uppercase tracking-widest">Genel Filtre</div>
                            </div>
                        </div>
                    </button>
                </div>
                        ...
                        <div className="p-6 border-b border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-[#1e293b] flex flex-col md:flex-row md:justify-between items-start md:items-center gap-4 shrink-0">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-[12px] bg-white dark:bg-[#0f172a] shadow-sm font-black text-blue-600 text-[18px] flex items-center justify-center border border-slate-200 dark:border-white/5">
                                    {String(selectedPerson?.name || "T").charAt(0)}
                                </div>
                                <div>
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                                <div className="flex bg-slate-200/50 dark:bg-[#0f172a] p-1 rounded-lg border border-slate-200 dark:border-slate-800">
                                    ...
                                    {paginatedStaffTasks.map((task: any) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-start mb-3">
                                                <h3 className="text-[15px] font-black text-slate-900 dark:text-white group-hover:text-blue-600 transition-colors line-clamp-1 pr-4">{task.title} <span className="text-[11px] font-medium text-slate-400 ml-2 font-mono">#{task.id.slice(-6).toUpperCase()}</span></h3>
