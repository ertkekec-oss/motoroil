...
export default function AdminGrowthAuditTrail() {
    ...
    return (
        <EnterprisePageShell
            ...
            description="Ağa etki eden tüm finansal, promosyonel ve yönetimsel aksiyonların (Boost/Policy/Guard) kayıt altına alındığı güvenli defter."
            actions={actions}
            ...
            <EnterpriseCard padding="none">
                ...
                {loading ? (
                    <div className="p-16 flex flex-col items-center justify-center text-slate-500 dark:text-slate-400">
                        ...
                        <span className="text-[11px] font-black tracking-widest uppercase">Denetim Kayıtları Taranıyor...</span>
                    </div>
                ) : (
                        ...
                        <table className="w-full text-left font-sans table-auto border-collapse">
                            <thead className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-white/5 text-[10px] uppercase tracking-widest font-black text-slate-500 dark:text-slate-400">
                                <tr>
                                    ...
                                    <th className="px-6 py-4">Aktör (Yönetici)</th>
                                    <th className="px-6 py-4">Zaman Damgası (Timestamp)</th>
                                    <th className="px-6 py-4 w-[45%] pr-6">Şifrelenmiş Payload (JSON)</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr>
                                        <td colSpan={4} className="p-16">
                                            <div className="flex flex-col items-center justify-center text-slate-400 dark:text-slate-500 space-y-3">
                                                ...
                                                <p className="text-[13px] font-black tracking-widest uppercase text-slate-900 dark:text-white">Güvenli Defter Bekliyor</p>
                                                <p className="text-[11px] font-bold uppercase tracking-widest opacity-60">Uygulanan veri filtresine uygun herhangi bir aksiyon veya denetim logu bulunamadı.</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}
