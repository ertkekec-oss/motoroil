...
export default async function AdminReconDisputesPage() {
    ...
    // Fetch all disputes across the tenant for admin view
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
                    <div>
                        ...
                        <h1 style={{ fontSize: '28px', fontWeight: '800', margin: '0 0 8px 0', letterSpacing: '-0.5px' }}>
                            Platform Uyuşmazlıkları (Disputes)
                        </h1>
                        <p style={{ color: 'var(--text-muted)', fontSize: '14px', margin: 0 }}>Sistemdeki tüm onay bekleyen veya çözülmüş mutabakat itirazları.</p>
                    </div>
                </div>
                ...
                <div style={{ background: 'var(--bg-card, rgba(239,68,68,0.02))', borderRadius: '20px', border: '1px solid rgba(239,68,68,0.2)', overflow: 'hidden' }}>
                    <div style={{ padding: '16px 24px', background: 'rgba(255,255,255,0.01)', borderBottom: '1px solid var(--border-color)', display: 'flex', gap: '16px', alignItems: 'center' }}>
                        <div style={{ fontSize: '12px', fontWeight: '800', textTransform: 'uppercase', color: 'var(--text-muted)' }}>Müşteriye Göre Ara:</div>
                        <input type="text" placeholder="Firma Adı veya Dispute ID..." style={{ padding: '6px 12px', background: 'transparent', border: '1px solid var(--border-color)', color: 'white', borderRadius: '6px', fontSize: '12px', width: '250px' }} />
