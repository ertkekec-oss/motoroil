            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
                    <div>
                        ...
                        <p style={{ color: 'var(--text-muted)', fontSize: '14px', margin: 0 }}>Bu sayfa yapılandırma aşamasındadır.</p>
                    </div>
                </div>
                <div style={{ background: 'rgba(255,255,255,0.02)', borderRadius: '20px', border: '1px solid var(--border-color)', padding: '64px 24px', textAlign: 'center' }}>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '14px', marginTop: '8px' }}>Bu modülün yönetim ekranları bir sonraki fazda aktif edilecektir.</p>
                </div>
            </div>
        </div>
    );
