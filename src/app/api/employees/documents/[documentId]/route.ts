...
export async function DELETE(req: Request, { params }: { params: Promise<{ documentId: string }> }) {
    try {
        ...
        // hr_manage veya staff_manage yetkisi ara
        ...
        // DB'den evrağı tenant/company bazlı doğrula ve bul
        ...
        try {
            ...
            console.warn('S3 file could not be deleted while preparing to delete Employee doc. Maybe it is orphan:', s3Error);
        }
        ...
        console.error('[Storage Error] Employee doc delete:', error);
