                                                    ...
                                                    {(() => {
                                                        ...
                                                        return (
                                                            <>
                                                                ...
                                                                {useFeatured ? (
                                                                    <div className="md:col-span-2 bg-slate-50 rounded-3xl shadow-xl flex flex-col md:flex-row relative group/feat border border-slate-200 min-h-[460px] overflow-visible">
                                                                        {/* Background Highlight */}
                                                                        <div className="absolute top-0 right-0 w-80 h-80 bg-white blur-[120px] rounded-full -translate-y-1/2 translate-x-1/2 opacity-60 pointer-events-none" />
                                                                        
                                                                        {/* LEFT: Image Area */}
                                                                        <div className="w-full md:w-[45%] bg-slate-100/50 p-6 flex flex-col relative shrink-0 border-r border-slate-200/60 rounded-l-3xl">
                                                                            <div className="flex-1 flex items-center justify-center relative min-h-[300px]">
                                                                                <img src={featuredProduct.image} alt={featuredProduct.name} className="w-full h-full max-h-[280px] object-contain filter drop-shadow-xl group-hover/feat:scale-105 transition-transform duration-700 mix-blend-multiply" />
                                                                                
                                                                                {/* BADGES Overlay */}
                                                                                <div className="absolute top-0 left-0 flex flex-col gap-2 z-10">
                                                                                    {featuredProduct.campaign && (
                                                                                        <div className="bg-emerald-600 text-white rounded-lg px-3 py-2 shadow-lg border border-emerald-500/20 flex items-center gap-2">
                                                                                    ...
                                                                                    {featuredProduct.pointsRate > 0 && (
                                                                                        <div className="bg-amber-500 text-white rounded-lg px-3 py-2 shadow-lg border border-amber-400/20 flex items-center gap-2">
                                                                        ...
                                                                        {/* RIGHT: Content Area */}
                                                                        <div className="flex-1 p-8 flex flex-col bg-white relative rounded-r-3xl">
                                                                            <div className="flex-1">
                                                                                <div className="flex items-center gap-2 mb-3">
                                                                                    <span className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.2em] bg-indigo-50 px-2.5 py-1 rounded-md">VİTRİNDEKİ ÜRÜN</span>
                                                                                ...
                                                                                <h3 className="text-2xl md:text-3xl font-black text-slate-900 leading-tight mb-4 group-hover/feat:text-indigo-600 transition-colors">
                                                                                ...
                                                                                <div className="relative">
                                                                                    <p className="text-[14px] text-slate-500 font-medium leading-relaxed line-clamp-5">
                                                                                ...
                                                                                <div className="flex items-center justify-between gap-4">
                                                                                    ...
                                                                                    <div className="flex items-center gap-3 shrink-0">
                                                                                        ...
                                                                                        <button 
                                                                                            ...
                                                                                            className={`h-12 px-8 rounded-2xl font-black text-[13px] tracking-wide transition-all active:scale-95 flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/10 min-w-[150px] ${addingToCart === featuredProduct.id ? 'bg-emerald-500 text-white' : 'bg-indigo-600 hover:bg-indigo-700 text-white'}`}
                                                                                        >
