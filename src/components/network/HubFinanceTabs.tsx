  ...
  const tabs = [
    {
      ...
      name: "Genel Bakış",
      icon: PieChart,
      href: "/hub/finance/dashboard",
    },
    {
      id: "finance",
      name: "Cüzdan & B2B Finans",
      icon: Wallet,
      href: "/hub/finance",
    },
    {
    ...
    },
    {
      ...
      name: "Boost Analitik",
      icon: BarChart,
      href: "/seller/boost/analytics",
    },
    {
      id: "trust",
      name: "Güven Skoru (Trust Score)",
      icon: ShieldCheck,
      href: "/hub/trust-score",
    },
  ];
    ...
    <div className="flex items-center gap-6 border-b border-slate-200 dark:border-white/10 mb-8 px-2 overflow-x-auto custom-scrollbar">
      {tabs.map((tab) => {
        const isActive =
          pathname === tab.href ||
          (tab.id === "finance" &&
            pathname.startsWith("/hub/finance") &&
            pathname !== "/hub/finance/dashboard");
        const Icon = tab.icon;
