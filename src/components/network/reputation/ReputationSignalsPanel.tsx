      ...
      <ul className="space-y-3">
        {signals?.map((sig, i) => (
          ...
          >
            <div>
              <span
                className={`text-xs font-bold px-2 py-1 rounded-sm mr-2 ${sig.direction === "POSITIVE" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
              >
                {sig.direction}
              </span>
