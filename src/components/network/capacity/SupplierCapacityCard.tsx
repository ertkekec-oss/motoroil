        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            ...
            <div className="flex gap-4 mb-4">
                ...
                <div className="flex-1 bg-blue-50 p-2 rounded-lg border border-blue-100 text-center">
                    ...
                    <span className="text-xs text-blue-600 block">Fulfillment Success</span>
                </div>
            </div>
            <p className="text-xs text-gray-500">Auto-calculated based on 30-day shipment throughput tracking.</p>
        </div>
    );
}
