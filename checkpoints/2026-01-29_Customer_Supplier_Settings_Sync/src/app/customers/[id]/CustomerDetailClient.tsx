...
export default function CustomerDetailClient({ customer, historyList }: { customer: any, historyList: any[] }) {
    ...
    const [activeTab, setActiveTab] = useState<'all' | 'sales' | 'payments' | 'documents' | 'services' | 'warranties'>('all');
    ...
    const { currentUser, refreshCustomers, refreshTransactions, products, warranties: warrantyPeriods } = useApp();
