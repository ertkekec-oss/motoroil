...
export default function AccountingPage() {
    ...
    const supplierPayables = useMemo(() => suppliers.filter(s => Number(s.balance) < 0).map(s => ({
        ...
        due: 'Vadeli',
        status: 'Cari Bakiye',
        branch: 'Merkez' // Suppliers don't have branch in schema, treating as global/merkez
    })), [suppliers]);
    ...
    return (
        <div className="container p-4 md:p-8 animate-in">
            ...
            <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
                {['Alacaklar', 'Borçlar', 'Çek & Senet', 'Banka & Kasa', 'Giderler'].map((label, i) => {
            ...
            <div className="card glass min-height-[500px]">
                ...
                {activeTab === 'payables' && (
                    <div>
                        ...
                        <table className="w-full text-left">
                            <thead className="text-muted text-xs border-b border-white/10"><tr><th className="p-3">Tedarikçi Bilgisi</th><th>Vade</th><th>Borç Tutarı</th><th>Durum</th><th></th></tr></thead>
                            <tbody>
