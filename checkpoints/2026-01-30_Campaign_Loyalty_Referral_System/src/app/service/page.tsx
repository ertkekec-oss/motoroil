...
export default function ServiceDashboard() {
    ...
    // Mock data for now since we don't have a broad list endpoint yet
    // In a real scenario, we'd fetch these from /api/services
    const [activeJobs, setActiveJobs] = useState<any[]>([
        { id: 'SRV-892', vehicle: 'Yamaha MT-07', plate: '34 MOT 123', entry: '09:30', status: 'İşlemde', technician: 'Ahmet Y.', customer: 'Mehmet Yılmaz', km: 12400 },
        { id: 'SRV-893', vehicle: 'Honda Africa Twin', plate: '06 HON 45', entry: '10:15', status: 'Beklemede', technician: 'Mustafa K.', customer: 'Ali Demir', km: 2800 },
        { id: 'SRV-894', vehicle: 'Suzuki V-Strom', plate: '35 SUZ 88', entry: '11:00', status: 'Tamamlandı', technician: 'Ahmet Y.', customer: 'Can Berk', km: 45000 },
    ]);

    const appointments = [
        { id: 1, time: '14:00', date: '29.01.2026', customer: 'Bülent Ecevit', vehicle: 'Kawasaki Z900', plate: '34 KAW 99', type: 'Genel Bakım' },
        { id: 2, time: '15:30', date: '29.01.2026', customer: 'Süleyman Demirel', vehicle: 'BMW R1250GS', plate: '06 BMW 12', type: 'Yağ Değişimi' },
    ];
