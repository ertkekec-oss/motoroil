...
function POSContent() {
  ...
  const { products, kasalar, processSale, customers, transactions, salesExpenses } = useApp();
  ...
  const finalTotal = Math.max(0, subtotal - manualDiscountAmount - couponDiscountAmount - pointsDiscountAmount);
