            ...
            {!isCounting && (
                <div className="flex items-center gap-3 mb-6 z-20 relative overflow-x-auto pb-2 scrollbar-none no-scrollbar flex-nowrap min-w-0">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {isCounting && (
                            <>
                                <button onClick={cancelReport} className="px-6 py-2.5 rounded-xl border border-red-500/30 text-red-400 hover:bg-red-500/10 font-bold text-xs uppercase tracking-wide transition-all">
                                    İptal
                                </button>
                                <button onClick={finishCount} className="px-6 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-white shadow-lg shadow-emerald-500/30 font-bold text-xs uppercase tracking-wide transition-all hover:scale-105">
                                    Raporu Tamamla
                                </button>
                            </>
                        )}
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <select className="w-full bg-black/40 border border-white/10 rounded-xl p-3 text-sm focus:border-primary outline-none"
                                        ...
                                        <option value="Madeni Yağ">Madeni Yağ</option>
                                    </select>
                                </div>
                                <div>
