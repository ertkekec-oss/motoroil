                    ...
                    <div style={{ display: 'flex', gap: '5px', alignItems: 'center' }}>
                        {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                            ...
                            (Math.abs(currentPage - page) <= 2 || page === 1 || page === totalPages) ? (
                                ...
                                (Math.abs(currentPage - page) === 3) && <span key={page} style={{ color: '#666' }}>...</span>
                            )
                        ))}
                    </div>
                    ...
                    <div className="card glass animate-in" style={{ width: '600px', background: '#1e1e24', border: '1px solid rgba(255,255,255,0.1)', maxHeight: '90vh', overflowY: 'auto' }}>
                        ...
                        <div className="flex-col gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" placeholder="Örn: Yedek Parça, Yağ..." value={newSupplier.category} onChange={e => setNewSupplier({ ...newSupplier, category: e.target.value })} style={{ width: '100%', padding: '12px', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: 'white' }} />
                            </div>
