...
export default function Sidebar() {
    ...
    const menuItems = [
        ...
        { name: 'Güvenlik Kalkanı', href: '/security/suspicious', icon: '🛡️' },
    ...
    const [activeBranch, setActiveBranch] = useState(displayUser?.branch || 'Merkez');

    useEffect(() => {
        if (displayUser?.branch) setActiveBranch(displayUser.branch);
    }, [displayUser]);
            ...
            <div style={{ flexShrink: 0 }}>
                ...
                <div style={{ padding: '0 24px 24px 24px' }}>
                    ...
                    <select
                        ...
                        <option value="kadikoy">🔧 KADIKÖY ŞUBE</option>
                        <option value="besiktas">🔧 BEŞİKTAŞ ŞUBE</option>
                        <option value="izmir">🔧 İZMİR ŞUBE</option>
                    </select>
                </div>
            </div>
